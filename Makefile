...
.PHONY: help install data train api test lint fmt image up down logs psql init-db test-postgres kafka check-kafka test-kafka redis check-redis test-redis produce consume stream metrics
